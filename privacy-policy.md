...
- Device storage and memory usage
- Camera and photo permissions status
...
2. Images temporarily sent to Google Gemini AI for analysis
...
### Automatic Deletion
- Database data is automatically deleted after retention periods expire
- Local data is permanently deleted when app is uninstalled
- Users can manually clear local data through app settings
...
- Keep your device secure and use device lock features
...
### Comparison Controls
- **Consent Management:** Control who can compare with you (processed locally)
- **Comparison History:** View and delete past comparisons (stored locally)
- **Privacy Settings:** Adjust what data is used in comparisons
- **Opt-Out:** Disable comparison features entirely
...
- **Social Sharing:** Control what data appears in shared content (from local storage)
...
- Only your chosen statistics and scores are included (from local storage)
- No raw images or detailed biometric data is shared
- You control what information appears in shared content
